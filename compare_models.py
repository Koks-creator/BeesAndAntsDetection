...
if __name__ == "__main__":
    models = {
        # "model2_vanila": {
        #     "detector": YoloDetector(model_path=f"{Config.MODELS_PATH}/model2_vanila/best (11).pt", 
        ...
        # },
        # "model3": {
        #     "detector": YoloDetector(model_path=f"{Config.MODELS_PATH}/model3/best (12).pt", 
        #                                 classes_path=f"{Config.MODELS_PATH}/classes.txt"),
        #     "detector_func_params": {"conf": .2, "iou": .35, "augment": True, "agnostic_nms": True},
        #     "type": ModelTypes.NEW.value
        # },
        ...
        #     "detector": YoloDetector(model_path=f"{Config.MODELS_PATH}/model2_vanila/best (11).pt", 
        #                                 classes_path=f"{Config.MODELS_PATH}/classes.txt"),
        #     "detector_func_params": {"slice_height": 512, "slice_width": 512,
        ...
        # "model4_sahi": {
        #     "detector": YoloDetector(model_path=f"{Config.MODELS_PATH}/model4/best (14).pt", 
        #                                 classes_path=f"{Config.MODELS_PATH}/classes.txt"),
        #     "detector_func_params": {"slice_height": 512, "slice_width": 512,
        #                              "overlap_height_ratio": 0.3, "overlap_width_ratio": 0.3},
        #     "type": ModelTypes.NEW_SAHI.value
        # },
        # "model5_sahi": {
        #     "detector": YoloDetector(model_path=f"{Config.MODELS_PATH}/model5_fine_tuned/best (15) fined tuned.pt", 
        #                                 classes_path=f"{Config.MODELS_PATH}/classes.txt"),
        #     "detector_func_params": {"slice_height": 512, "slice_width": 512,
        #                              "overlap_height_ratio": 0.3, "overlap_width_ratio": 0.3},
        #     "type": ModelTypes.NEW_SAHI.value
        ...
        #     "type": ModelTypes.NEW.value
        # },
        "model5_fine_tuned_sahi": {
            "detector": YoloDetector(model_path=f"{Config.MODELS_PATH}/model5_fine_tuned/best (15) fined tuned.pt", 
                                     classes_path=f"{Config.MODELS_PATH}/classes.txt"),
            "detector_func_params": {
                "slice_height": 300,
                "slice_width": 300,
